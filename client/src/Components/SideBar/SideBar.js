...
import StoreLocations from "../../Assets/store.png";
...
const SideBar = ({ isShowing }) => {
  ...
  return (
    <>
      {isShowing ? (
        <div className="h-full lg:w-2/12">
          <div className="left-sidebar left-4 h-full w-full ">
            <div className="h-full w-64 bg-slate-700 rounded-lg p-2 flex flex-col overflow-scroll">
              ...
              {isOpen ? (
                <div>
                  ...
                  >
                    <img src={Zone} alt="" className="w-5 h-5 invert" />
                    <h1 className="text-white">Zones</h1>
                  </div>
                  {/* ....Store-Locations... */}
                  <div
                    className={`${
              ...
              <div className="third flex flex-col justify-end h-full mt-4">
                {/* Download Reports */}
